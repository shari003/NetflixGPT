...
export const {addNowPlayingMovies, addTrailer, addPopularMovies, addMovieInfo, addMovieTrailers, addCastInfo, addTopRatedMovies, addUpcomingMovies} = movieSlice.actions;
